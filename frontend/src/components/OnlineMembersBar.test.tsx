...
describe('OnlineMembersBar', () => {
  ...
  it('exibe "Online agora: 2" com dois avatares', () => {
    ...
    render(<OnlineMembersBar members={[selfMember, secondMember]} currentUserId={selfMember.userId} />);
  ...
  it('exibe iniciais quando avatarUrl é null', () => {
    ...
    render(<OnlineMembersBar members={[selfMember, memberWithoutAvatar]} currentUserId={selfMember.userId} />);

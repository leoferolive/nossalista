...
describe('MembersModal', () => {
  ...
  it('deve chamar onConfirmLeave ao clicar em "Sair" na confirmação', () => {
    ...
    render(
      <MembersModal {...defaultProps} isLeaveConfirmOpen={true} onConfirmLeave={onConfirmLeave} />
    )
  ...
  it('deve chamar onCancelLeave ao clicar em "Cancelar" na confirmação', () => {
    ...
    render(
      <MembersModal {...defaultProps} isLeaveConfirmOpen={true} onCancelLeave={onCancelLeave} />
    )
  ...
  it('deve mostrar modal de confirmação quando removeConfirmMemberId está definido', () => {
    ...
    expect(
      screen.getByText(/Remover memberuser\? Ação não pode ser desfeita\./)
    ).toBeInTheDocument()

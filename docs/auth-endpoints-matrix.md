...
| `POST` | `/mcp` | clientes MCP externos (claude.ai, Claude Code/Desktop, Cursor) | Requer JWT, PAT (`nlmcp_...`) ou access token OAuth do MCP. Enforcement de escopo READ e por tool, nao por metodo HTTP — ver `docs/mcp.md` e `docs/DECISIONS.md` (D-020, D-021) |

## Endpoints do servidor de autorizacao OAuth do MCP (Fase C, D-021)

 ...
 * MCP (ver {@code McpMutationRateLimitAspect}). Vira um resultado de tool com
 * {@code isError: true} pelo mesmo mecanismo genérico do SDK que converte
 * {@link McpAuthenticationException}/{@link McpScopeException} — nunca stack
 * trace nem erro de protocolo.
 */

...
public class ListItemMapper {
    ...
    /**
     * Atualiza entidade existente com dados do UpdateItemRequestDTO
     * Apenas campos não nulos são atualizados (patch semantics)
     *
     * IMPORTANTE: Para limpar campos nullable (quantity, dueDate, url),
     * o serviço deve setar explicitamente para null APÓS chamar este método.
     * Este método não diferencia entre "campo ausente" e "campo = null".
     *
     * Exemplo para limpar quantity:
     * <pre>
     * mapper.updateEntityFromDTO(item, dto);
     * if (shouldClearQuantity) {
     *     item.setQuantity(null);
     * }
     * </pre>
     *
     * @param item entidade a ser atualizada
     * @param dto dados de atualização
     */
    public void updateEntityFromDTO(ListItem item, UpdateItemRequestDTO dto) {

...
public class ActivityMcpTools {
    ...
    public ActivityMcpTools(ActivityLogService activityLogService, McpSecurityContext security) {
    ...
    public ActivityPageResult getListActivity(
        ...
        return new ActivityPageResult(entries, response.number(), response.size(), response.totalElements(), response.totalPages());
    }

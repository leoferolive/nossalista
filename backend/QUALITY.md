...
- **Atualizacao de rotina (2026-07-13)**: bump patch/minor de dependencias (ver PR de `chore/deps-upgrade-2026-07-13`) atualizou os overrides acima para tomcat `11.0.24`, netty `4.2.16.Final`, postgresql `42.7.13`, swagger-ui `5.32.8`, springdoc `3.0.3`, jjwt `0.13.0`. Spring Boot permanece no parent `4.0.7` — o trem `4.1.0` (minor) esta disponivel mas foi deliberadamente adiado por afetar todos os `spring-boot-starter-*` simultaneamente e nao poder ser compilado/testado localmente neste ambiente (sem JDK 25).
